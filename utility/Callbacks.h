#ifndef _RES_CALLBACKS_H_
#define _RES_CALLBACKS_H_
...
template< typename ObjectType, typename Function >
inline Callback* Callback :: create(ObjectType* obj, Function f)
{
	return new Callback0<ObjectType, Function>(obj, f);
}

template< typename ObjectType, typename Function, typename BoundParam1 >
inline Callback* create(ObjectType* obj, Function f, BoundParam1 bp1)
{
	return new Callback1<ObjectType, Function, BoundParam1>(obj, f, bp1);
}

template< typename ObjectType, typename Function, typename BoundParam1, typename BoundParam2 >
inline Callback* create(ObjectType* obj, Function f, BoundParam1 bp1, BoundParam2 bp2)
{
	return new Callback2<ObjectType, Function, BoundParam1, BoundParam2>(obj, f, bp1, bp2);
}
